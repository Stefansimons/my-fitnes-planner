  ...
  sections: [
    {
      ...
      children: [
        ...
        bullet('Login/auth tok prebacen na modularni Firebase provider setup'),
        ...
        bullet('TrainingForm create/update kroz WorkoutFacade', true),
        bullet('Ukloniti poslednji legacy bridge za edit formu', false),
