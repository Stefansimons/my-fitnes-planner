...
function statusTable() {
  const rows = [
    ...
    ['Domain/API/Adapter', 'Zapocto', 'Workout model i adapter postoje'],
  ...
  sections: [
    {
      ...
      children: [
        ...
        bullet('Definisati Workout, WorkoutExercise i WorkoutSet domain modele', false),
        bullet('Odvojiti Firestore DTO od frontend domain modela', false),
        bullet('Dodati i testirati adapter DTO <-> domain', false),
        bullet('Izdvojiti API service, zatim WorkoutState i WorkoutFacade', false),
